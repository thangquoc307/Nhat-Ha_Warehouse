...
insert into `items_serials` (`serial`, `item_id`, `status_id`) values
('G1SK79C012152', 1, 1), ('G1SK79C001130', 1, 1), ('G1SK79C004204', 1, 1),
('G1SK79C004672', 1, 1), ('G1SK79C01049B', 1, 1), ('G1SK79C020480', 1, 1),
('G1SK79C002916', 1, 1), ('G1SK79C004461', 1, 1), ('G1SK79C007269', 1, 1),
('G1SK79C013305', 1, 1), ('G1SK79C020763', 1, 1), ('G1SK79C00391B', 1, 1),
('G1SK79C007818', 1, 1), ('G1SK79C008447', 1, 1), ('G1SK79C008679', 1, 1),
('G1SK79C00891A', 1, 1), ('G1SK79C003988', 1, 1), ('G1SK79C008405', 1, 1),
('G1SK79C008502', 1, 1), ('G1SK79C008831', 1, 1), ('G1SK79C014757', 1, 1),
('G1SK79C033191', 1, 1);
...
insert into `items_serials` (`serial`, `item_id`, `status_id`) values
('G1SU2SY003010', 3, 1), ('G1SU2SY002921', 3, 1);
...
insert into `items_serials` (`serial`, `item_id`, `status_id`) values
('G1SPCD108443A', 7, 1), ('G1SPCD1084486', 7, 1), ('G1SPCD1085833', 7, 1), 
('G1SPCD1083009', 7, 1), ('G1SPCD1084794', 7, 1), ('G1SPCD1084609', 7, 1), 
('G1SPCD1085829', 7, 1), ('G1SPCD108618C', 7, 1), ('G1SPCD1084537', 7, 1), 
('G1SPCD108485C', 7, 1), ('G1SPCD1058049', 7, 1), ('G1SPCD1057964', 7, 1), 
('G1SPCD1059324', 7, 1), ('G1SPCD105950A', 7, 1), ('G1SPCD1057922', 7, 1), 
('G1SPCD1059560', 7, 1), ('G1SPCD1059463', 7, 1), ('G1SPCD1057871', 7, 1), 
('G1SPCD105933B', 7, 1), ('G1SPCD105947A', 7, 1);
...
insert into `items_serials` (`serial`, `item_id`, `status_id`) values
('CNQVLBMB5M', 8, 1), ('CNQVLBMB5D', 8, 1), ('CNQVLBMB5G', 8, 1), 
('CNQVLBMB53', 8, 1), ('CNQVLBMB3J', 8, 1), ('CNQVLBMB5F', 8, 1), 
('CNQVLBMB4X', 8, 1), ('CNQVLBMB59', 8, 1), ('CNQVLBMB52', 8, 1), 
('CNQVLBMB56', 8, 1);
...
insert into `items_serials` (`serial`, `item_id`, `status_id`) values
('G1RU8BQ03308A', 11, 1), ('G1RU8BQ03315C', 11, 1), ('G1RU8BQ033124', 11, 1),
('G1RU8BQ033048', 11, 1), ('G1RU8BQ031878', 11, 1);
...
insert into `items_serials` (`serial`, `item_id`, `status_id`) values
('G1SU4SL001162', 12, 1), ('G1SU4SL001310', 12, 1), ('G1SU4SL00110C', 12, 1);
...
insert into `items_serials` (`serial`, `item_id`, `status_id`) values
('CNQDLJ6G16', 14, 1), ('CNQDLJ6G30', 14, 1), ('CNQDLJ6F7L', 14, 1);  
...
insert into `items_serials` (`serial`, `item_id`, `status_id`) values    
('CNQDLJ6G33', 21, 1), ('CNQDLJ6G35', 21, 1), ('CNQDLJ6D9W', 21, 1), ('CNQDLJ6G2M', 21, 1);  
...
insert into `items_serials` (`serial`, `item_id`, `status_id`) values
('G1RU8BQ03311A', 23, 1), ('G1RU8BQ033069', 23, 1), ('G1RU8BQ01932A', 23, 1), ('G1RU8BQ010978', 23, 1);  
...
insert into `items_serials` (`serial`, `item_id`, `status_id`) values
('G1T03GV009612', 24, 1), ('G1T03GV009599', 24, 1), ('G1T03GV009540', 24, 1), ('G1T03GV00952C', 24, 1);  
...
insert into `items_serials` (`serial`, `item_id`, `status_id`) values
('CNQVLBMB4K', 25, 1), ('CNQVLBMB46', 25, 1);   
...
insert into `items_serials` (`serial`, `item_id`, `status_id`) values
('CNP8KPPFWS', 26, 1), ('CNQVLBMB4P', 26, 1), ('CNQVLBMB32', 26, 1),
('CNQVLBMB4W', 26, 1), ('CNQVLBMB4T', 26, 1), ('CNR5KPP297', 26, 1),
('CNQVLBMB4L', 26, 1), ('CNQVLBMB4J', 26, 1), ('CNQVLBMB4N', 26, 1),
('CNQVLBMB4H', 26, 1);      
...
insert into `items_serials` (`serial`, `item_id`, `status_id`) values
('G1SU2SY002444', 28, 1), ('G1SU2SY00194A', 28, 1);  
...
insert into `items_serials` (`serial`, `item_id`, `status_id`) values
('PSZ27081K33', 31, 1), ('PSZ27081JDN', 31, 1);
...
insert into `items_serials` (`serial`, `item_id`, `status_id`) values
('G1SK79C028203', 32, 1), ('G1SK79C028194', 32, 1), ('G1SK79C031528', 32, 1),
('G1SK79C024487', 32, 1), ('G1SK79C023575', 32, 1), ('G1SK79C031507', 32, 1);
...
insert into `items_serials` (`serial`, `item_id`, `status_id`) values
('G1RU8BQ030620', 35, 1), ('G1RU8BQ031194', 35, 1);
...
insert into `items_serials` (`serial`, `item_id`, `status_id`) values
('G1T03GV009696', 36, 1), ('G1T03GV048030', 36, 1);
...
insert into `items_serials` (`serial`, `item_id`, `status_id`) values
('G1T03GV009633', 38, 1), ('G1T03GV04848A', 38, 1), ('G1T03GV048220', 38, 1),
('G1T03GV00949C', 38, 1), ('G1T03GV048503', 38, 1), ('G1T03GV009654', 38, 1),
('G1T03GV048410', 38, 1), ('G1T03GV048448', 38, 1), ('G1T03GV009629', 38, 1),
('G1T03GV009582', 38, 1), ('G1T03GV048494', 38, 1), ('G1T03GV04834B', 38, 1),
('G1T03GV048241', 38, 1), ('G1T03GV009578', 38, 1), ('G1T03GV048427', 38, 1),
('G1T03GV04832A', 38, 1), ('G1T03GV00966B', 38, 1), ('G1T03GV048452', 38, 1);

select n.note, n.partner, n.release_date, n.so, i.description, i.part_number, s.name, ifnull(i.count, count(*)) as count from stock_notes n
